      ...
      <main className="mesh-bg flex-1 min-h-screen overflow-y-auto px-5 md:px-8 py-6 md:py-8">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
          <section className="glass-card p-4">
            <p className="text-[11px] uppercase tracking-[0.12em]" style={{ color: "rgba(29,29,31,0.5)" }}>
              Active Students
            </p>
            <p className="mt-1 text-[26px] font-bold leading-none" style={{ color: "var(--foreground)" }}>
